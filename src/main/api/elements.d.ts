...
export namespace elements {
  ...
  export function register(definition: ElementDefinition): {
    elementType: ElementType;
  };
  export function updateDefinition(
    elementTypeOrId: string | ElementType,
    partial: Partial<ElementDefinition>
  ): void;
  export function addInteractionInfo(
    elementTypeOrId: string | ElementType,
  ...
  export function setVelocityAtCellWhenIdle(
    ...args: [...CellCoordinates, velocity: Vector2]
  ): void;
  export function addParticleVelocityAtCellWhenIdle(
    ...args: [...CellCoordinates, velocity: Vector2, maxSpeed?: number]
  ): void;
  export function convertToParticleAtCellWhenIdle(
    ...args: [...CellCoordinates, velocity: Vector2]
  ): void;
  export function convertFromParticleAtCellWhenIdle(
