...
export namespace structures {
  ...
  export function addProcessor(
    structureId: string | StructureType,
  ...
  export function addVariant(
    baseStructureTypeOrId: string | StructureType,
    variant: { id: string | StructureType; angles: number[] },
    options?: { addBuildMode?: any }
  ): void;
  export function registerPlacementConfig(
    definition: PlacementConfigDefinition
  ): void;
  ...
  export function isUnlockedByType(
    structureType: string | StructureType
  ): boolean;
  export function mapValueToSpritesheetIndex(
    value: number,
    thresholds: number[]
  ): number;
  export function buildAtCellWhenIdle(
    ...args: [...CellCoordinates, structureTypeOrId: string, options?: any]
  ): void;
  export function removeAtCellWhenIdle(
    ...args: [
      ...CellCoordinates,
      options?: { removeCells?: boolean; skipVisuals?: boolean }
    ]
  ): void;
  ...
  export namespace recipes {
    export function register(
      id: "planterBox",
      definition: PlanterBoxRecipeDefinitionV1
    ): void;
    export function register(
      id: "shaker",
      definition: ShakerRecipeDefinitionV1
    ): void;
    export function register(
      id: "kineticPress",
      definition: KineticPressRecipeDefinitionV1
    ): void;
    export function register(
  ...
  export namespace processing {
    ...
    export function register(
      id: string,
      definition: StructureProcessingDefinitionV1
    ): void;
    export function setEnabledAt(
      ...args: [...CellCoordinates, enabled: boolean]
    ): boolean;
  }
